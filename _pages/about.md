...
<div style="display: flex; align-items: flex-start; margin-bottom: 60px;">
  ...
  <div style="text-align: justify;">
    <h3 style="margin: 0;">Vision-Based Semantic Segmentation in Scene Understanding for Autonomous Driving: Recent Achievements, Challenges, and Outlooks [CODE](https://github.com/hayatkhan8660-maker/Light-DehazeNet)</h3>
